...
function render_sidebar($current_page) {
    ...
    <div class="sidebar">
        ...
        <ul>
            <li class="<?php echo is_active('home', $current_page); ?>"><a href="index.php">Home</a></li>
            <li class="<?php echo is_active('bookings', $current_page); ?>"><a href="trainer">Personal Trainer</a></li>
            <li class="<?php echo is_active('bmi', $current_page); ?>"><a href="bmi.php">BMI Scale</a></li>
            <li class="<?php echo is_active('members', $current_page); ?>"><a href="members.php">Member Info</a></li>
            <li class="<?php echo is_active('help', $current_page); ?>"><a href="help.php">Help</a></li>
        </ul>
